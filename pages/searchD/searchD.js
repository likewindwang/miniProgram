...
Page({
    ...
    onLoad: function (options) {
        ...
        var sUrl = ''
        if (this.data.keyWay == 'names'){
            sUrl = '/v2/movie/search?q=' + this.data.keyWords
        }else {
            sUrl = '/v2/movie/search?tag=' + this.data.keyWords
        }
        this.setData({
            sUrl: sUrl
        })
    ...
    getHotData() {
        ...
        wx.request({
            ...
            url: app.globalData.basicApi + _this.data.sUrl,
                ...
                if (res.statusCode == 200 && res.errMsg == "request:ok") {
                    ...
                    for (var i = 0; i < res.data.subjects.length; i++) {
                        ...
                        for (var j = 0; j < res.data.subjects[i].casts.length; j++) {
                            ...
                            if (res.data.subjects[i].casts[0].name.indexOf('·') > -1) {
